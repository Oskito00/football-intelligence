...
df = pd.read_csv('sportradar/data/processed_data/test_data_no_h2h.csv')
...
df_features.to_csv('sportradar/AI/processed_data/test_no_h2h_preprocessed_features.csv', index=False)
