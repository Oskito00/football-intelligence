...
from ml_pipeline.evaluation.evaluate_predictions import evaluate_model
...
def _run_cross_validation(model, X: pd.DataFrame, y: pd.Series, 
                         cv_config: Dict[str, Any]) -> np.ndarray:
